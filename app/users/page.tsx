...
export default function UsersPage() {
  ...
  const openEditUserDialog = (user: (typeof initialUsers)[0]) => {
    setNewUser({
      name: user.name,
      email: user.email,
      phone: user.phone,
  ...
  const sortUsers = (usersToSort: typeof initialUsers) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{users.reduce((sum, u) => sum + u.tasksAssigned, 0)}</div>
            <p className="text-xs text-muted-foreground">
              <span className="text-green-600">{users.reduce((sum, u) => sum + u.tasksCompleted, 0)}</span> completed
            </p>
          </CardContent>
        </Card>
        <Card>
                  ...
                  <TableCell>
                    <div className="space-y-1">
                      <div className="text-sm">
                        ...
                        <span className="text-muted-foreground">/{user.tasksAssigned} completed</span>
                      </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveUser}>{editingUser ? "Update Team Member" : "Add Team Member"}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
